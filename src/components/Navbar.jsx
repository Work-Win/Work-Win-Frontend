...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white">
      <img className="w-[76px] mx-2 my-4" src={Logo} />
      <h1 className="w-full text-3xl font-medium mx-3 text-[#a8def2]">
        WORK & WIN
      </h1>
      ...
      >
        <h1 className="w-full text-3xl font-bold text-[#a8def2] m-4">
          WORK & WIN
        </h1>
